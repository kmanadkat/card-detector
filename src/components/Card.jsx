...
function Card({ children }) {
  return (
    <div className='card-container card-container-shadow bg-blue-500 absolute rounded-2xl overflow-hidden -top-44 w-[90%] md:w-[85%] left-1/2 -translate-x-1/2 h-[300px]'>
