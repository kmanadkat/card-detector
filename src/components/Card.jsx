...
function Card({ children }) {
  return (
    <div className='card-container card-container-shadow absolute rounded-2xl overflow-hidden -top-32 sm:-top-44 w-[90%] md:w-[85%] left-1/2 -translate-x-1/2 h-[240px] sm:h-[300px]'>
